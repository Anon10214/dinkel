...
<p align=center>
  <img alt="License Badge" src="https://img.shields.io/github/license/Anon10214/biscepter">
  <a href="https://pkg.go.dev/github.com/Anon10214/dinkel/biscepter?tab=doc"><img src="https://godoc.org/github.com/golang/gddo?status.svg" alt="Biscepter GoDoc"></a>
</p>

<p align=center>
  <a href="https://github.com/Anon10214/dinkel/biscepter/actions/workflows/build.yml"><img alt="CI/CD Build Status Badge" src="https://github.com/Anon10214/dinkel/biscepter/actions/workflows/build.yml/badge.svg"></a>
  <a href="https://github.com/Anon10214/dinkel/biscepter/actions/workflows/test.yml"><img alt="CI/CD Test Status Badge" src="https://github.com/Anon10214/dinkel/biscepter/actions/workflows/test.yml/badge.svg"></a>
  <a href="https://codecov.io/gh/Anon10214/biscepter"><img alt="CI/CD Coverage Status Badge" src="https://codecov.io/gh/Anon10214/biscepter/branch/main/graph/badge.svg?token=lY5KKsQlpx"/></a>
</p>
...
Installing directly:
```
$ go install github.com/Anon10214/dinkel/biscepter@latest
```
...
```
$ git clone git@github.com:Anon10214/biscepter.git
$ cd biscepter
$ go build
```
...
This repository contains a [Go package](/pkg/biscepter), whose documentation can be found [here](https://pkg.go.dev/github.com/Anon10214/dinkel/biscepter/pkg/biscepter).
