...
func TestClauseCapturer_SchemaPreserved(t *testing.T) {
	...
	clause := helperclauses.GetClauseCapturerForClause(&clauses.ExistingLabel{}, mock.Implementation{})

	// This assembler ensures that the schema gets modified before and after the clause does
	setupClauses := helperclauses.CreateAssemblerWithoutTemplateString([]translator.Clause{
		&clauses.NewLabel{},
		clause,
	})
...
func TestClauseCapturer_UpdateClauseSchemaPreserved(t *testing.T) {
	clause := helperclauses.GetClauseCapturerForClause(&clauses.EmptyClause{}, mock.Implementation{})
...
func TestClauseCapturer_RenewClauseSchemaNotPreserved(t *testing.T) {
	...
	capturedHookClause := helperclauses.GetClauseCapturerForClause(hookClause, mock.Implementation{})
...
func TestClauseCapturer_RespectsImplementation(t *testing.T) {
	...
	clause := helperclauses.GetClauseCapturerForClause(&clauses.EmptyClause{}, impl)
	...
	res := translator.GenerateStatement(
		seed,
		schema,
		clause,
		impl,
...
func TestCapturedClause(t *testing.T) {
	...
	captured := helperclauses.GetClauseCapturerForClause(clause, mock.Implementation{})
...
func TestCapturedSchema(t *testing.T) {
	...
	// the hook clause
	statement := helperclauses.CreateAssemblerWithoutTemplateString([]translator.Clause{
