...
func (s *Schema) AddPropertyVariable(variable PropertyVariable) {
	...
	logrus.Debugf("Added property variable with name %s and type 0x%X", variable.Name, variable.Type)
...
func (s *Schema) AddStructuralVariable(variable StructuralVariable) {
	...
	logrus.Debugf("Added structural variable with name %s and type 0x%X", variable.Name, variable.Type)
