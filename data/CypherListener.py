...
class CypherListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CypherParser#oC_CountSubquery.
    def enterOC_CountSubquery(self, ctx:CypherParser.OC_CountSubqueryContext):
        pass

    # Exit a parse tree produced by CypherParser#oC_CountSubquery.
    def exitOC_CountSubquery(self, ctx:CypherParser.OC_CountSubqueryContext):
        pass
