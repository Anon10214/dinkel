...
If you are using an amd64/linux machine, download the assets of release v0.1.0, whereas if you are using something else, download them from the v0.1.1 release.  
